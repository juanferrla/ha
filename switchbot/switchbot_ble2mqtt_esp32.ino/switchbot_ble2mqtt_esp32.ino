...
static const char* ssid = "JUZUM";                                   //  WIFI SSID
static const char* password = "XXXX";                           //  WIFI Password

/* MQTT Settings */
/* MQTT Client name is set to WIFI host from Wifi Settings*/
static const char* mqtt_host = "192.168.123.12";                       //  MQTT Broker server ip
static const char* mqtt_user = "mqtt";                         //  MQTT Broker username. If empty or NULL, no authentication will be used
static const char* mqtt_pass = "XXXX";                         //  MQTT Broker password
...
static std::map<std::string, std::string> allBots = {
  { "switchbot_balcon", "DC:86:AC:FE:A2:22" },
  { "switchbot_entrada", "C2:E4:0F:87:FE:4D" },
  { "switchbot_sala", "E4:22:51:2D:D2:A2" }    
};
...
static std::map<std::string, std::string> allMeters = {
  { "meter_perro", "D0:A0:40:4B:57:65" },
  { "meter_exterior", "D0:C2:02:13:EB:72" }
};
